...
async function registerPaginations(paginations, ctx) {
    ...
    for (const { pid, id, filter, sorter, layout, lengthPerPage, getPaginationPageUrl, getPaginationPageTitle, } of paginations) {
        ...
        const extraPages = pagination.pages
            ...
            return {
                ...
                frontmatter: {
                    layout,
                    title: getPaginationPageTitle(index, id, pid),
                },
                meta: {
                    pid,
                    id,
